...
public class GymApp {
    ...
    // Trainer menu
    private static void showTrainerMenu(Scanner scanner, User user, UserService userService, MembershipService membershipService,
...
try {
    ...
    switch (trainerChoice){
        ...
        WorkoutClass updatedClass = new WorkoutClass(classIdToUpdate, newClassType, newClassDescription, user.getUserId());
        ...
        case 4:
        List <WorkoutClass> workoutClasses = workoutService.getAllWorkoutClassesByTrainer(user.getUserId());
        ...
        if (workoutClasses.isEmpty()){
            ...
            for (WorkoutClass wc : workoutClasses){
                System.out.println("ID: " + wc.getClassId() + ",Type: " + wc.getClassType() + ", Description: " + wc.getClassDescription());
            }
        }break;
